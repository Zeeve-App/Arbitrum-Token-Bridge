    ...
    <div className="flex flex-col gap-3">
      <form onSubmit={onSubmit} className="flex flex-col">
        <div className="flex items-stretch gap-2">
          <div className="relative flex h-full w-full grow items-center rounded border-[1px] border-white bg-[#111111] px-2 text-white shadow-input">
      ...
      <div
        className="sm:shadow-search-panel h-[calc(100vh_-_190px)] overflow-hidden rounded border border-white bg-[#111111] text-white sm:h-[400px]"
        data-cy={dataCy}
      >
        {children}
      </div>
