...
import Logo from '@/images/ECM-chain-logo.svg'
  ...
  return (
    <header
      className={twMerge(
        ...
        isTestnet
          ? 'sm:border-b sm:border-[#FF8E01] sm:bg-[#111111]'
          : 'sm:bg-transparent'
      )}
    >
      <div className="flex w-full items-center justify-end gap-2 text-[#FF8E01]">
